...
|:--:|:--|:--|
| **Part I** | **Matroids and submodular minimization** | [Handwritten notes](/files/lecture-notes/Matroids.pdf) |
...
| **Part II** | **Submodular maximization** | [Handwritten notes](/files/lecture-notes/Submod_max.pdf) |
| [Lec 5](/files/lecture-notes/Lec5.pdf) | **Greedy** | Greedy for monotone submodular maximization under cardinality constraint; matroid constraint; uniform-sampling for unconstrained nonmonotone submodular maximization; multilinear extension.<br>**Readings:** [Nemhauser, Wolsey, and Fisher (1978)](https://doi.org/10.1007/BF01588971); [Cornuéjols, Fisher, and Nemhauser (1977)](https://doi.org/10.1016/S0167-5060%2808%2970732-5); [Feige, Mirrokni, and Vondrák (2011)](https://doi.org/10.1137/090779346). |
| [Lec 6](/files/lecture-notes/Lec6.pdf) | **Continuous greedy** | Double greedy; continuous greedy; measured continuous greedy.<br>**Readings:** [Buchbinder et al. (2015)](https://doi.org/10.1137/130929205); [Călinescu et al. (2011)](https://doi.org/10.1137/080733991); [Feldman, Naor, and Schwartz (2011)](https://doi.org/10.1109/FOCS.2011.46). |
| [Lec 7](/files/lecture-notes/Lec7.pdf) | **Local search** | Local search for monotone submodular maximization under matroid constraint; matching constraint; polyhedral view of local search.<br>**Reading:** [Bruggmann and Zenklusen (2019)](https://doi.org/10.1287/moor.2018.0965).<br>**Optional:** monotone submodular maximization under k matroid constraints [Lee et al. (2009)](https://doi.org/10.1287/moor.1100.0463); [Singer and Thiery (2026)](https://doi.org/10.48550/arXiv.2607.00843). |
