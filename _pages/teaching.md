...
| [Lec 7](/files/lecture-notes/Lec7.pdf) | **Local search** | Local search for monotone submodular maximization under matroid constraint; matching constraint; polyhedral view of local search.<br>**Reading:** [Bruggmann and Zenklusen (2019)](https://doi.org/10.1287/moor.2018.0965).<br>**Optional:** monotone submodular maximization under k matroid constraints [Lee et al. (2009)](https://doi/10.1287/moor.1100.0463); [Singer and Thiery (2026)](https://doi:10.48550/arXiv.2607.00843). |
